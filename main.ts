...
function cadastrarLivro(book: Livro) {
    ...
    const estoque = Number(prompt("Digite o Numero de copias a ser adicionado: ") || 0);

    book.cadastrarLivro(nome, descricao, preco, autores, dataPubli, paginas, conteudo, ismbm, estoque);
}
